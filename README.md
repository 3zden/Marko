...
- First run prints a big purple "MARKO!!" ASCII banner with a moon and owl; every launch after that plays a short sparkle-spinner, in the style of Claude Code's startup flourish. Both fall back to plain text when output isn't a terminal.
